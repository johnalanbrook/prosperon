...
extern const float UNITMAT4[16];
...
extern const mfloat_t DOWN[3];
extern const mfloat_t FORWARD[3];
extern const mfloat_t BACK[3];
...
/* Standards for easy using */

extern const mfloat_t VEC2_ZERO[2];
extern const mint_t VEC2I_ZERO[2];
extern const mfloat_t VEC3_ZERO[3];
extern const mint_t VEC3I_ZERO[3];

extern const mfloat_t VEC2_ONE[2];
extern const mint_t VEC2I_ONE[2];
extern const mfloat_t VEC3_ONE[3];
extern const mint_t VEC3I_ONE[3];
...
mint_t *vec2i_clamp(mint_t *result, mint_t *v0, mint_t *v1,
                    mint_t *v2);
...
mint_t *vec3i_clamp(mint_t *result, mint_t *v0, mint_t *v1,
                    mint_t *v2);
...
mint_t *vec4i_clamp(mint_t *result, mint_t *v0, mint_t *v1,
                    mint_t *v2);
#endif
#if defined(MATHC_USE_FLOATING_POINT)
...
mfloat_t *vec2_subtract(mfloat_t *result, mfloat_t *v0,
                        mfloat_t *v1);
mfloat_t *vec2_subtract_f(mfloat_t *result, mfloat_t *v0,
                          mfloat_t f);
mfloat_t *vec2_multiply(mfloat_t *result, mfloat_t *v0,
                        mfloat_t *v1);
mfloat_t *vec2_multiply_f(mfloat_t *result, mfloat_t *v0,
                          mfloat_t f);
...
mfloat_t *vec2_project(mfloat_t *result, mfloat_t *v0,
                       mfloat_t *v1);
mfloat_t *vec2_slide(mfloat_t *result, mfloat_t *v0,
                     mfloat_t *normal);
mfloat_t *vec2_reflect(mfloat_t *result, mfloat_t *v0,
                       mfloat_t *normal);
...
mfloat_t *vec3_project(mfloat_t *result, mfloat_t *v0,
                       mfloat_t *v1);
mfloat_t *vec3_slide(mfloat_t *result, mfloat_t *v0,
                     mfloat_t *normal);
mfloat_t *vec3_reflect(mfloat_t *result, mfloat_t *v0,
                       mfloat_t *normal);
...
bool vec3_linear_independent(mfloat_t *v0, mfloat_t *v1,
                             mfloat_t *v2);
...
mfloat_t *vec4_subtract(mfloat_t *result, mfloat_t *v0,
                        mfloat_t *v1);
mfloat_t *vec4_subtract_f(mfloat_t *result, mfloat_t *v0,
                          mfloat_t f);
mfloat_t *vec4_multiply(mfloat_t *result, mfloat_t *v0,
                        mfloat_t *v1);
mfloat_t *vec4_multiply_f(mfloat_t *result, mfloat_t *v0,
                          mfloat_t f);
...
mfloat_t *quat_mult_3d(mfloat_t *result, const mfloat_t *q,
                       const mfloat_t *p);
mfloat_t *quat_multiply_f(mfloat_t *result, mfloat_t *q0,
                          mfloat_t f);
...
mfloat_t *quat_power(mfloat_t *result, mfloat_t *q0,
                     mfloat_t exponent);
mfloat_t *quat_from_axis_angle(mfloat_t *result, const mfloat_t *v0,
                               const mfloat_t angle);
mfloat_t *quat_from_vec3(mfloat_t *result, mfloat_t *v0,
                         mfloat_t *v1);
...
mfloat_t *mat2_multiply(mfloat_t *result, mfloat_t *m0,
                        mfloat_t *m1);
mfloat_t *mat2_multiply_f(mfloat_t *result, mfloat_t *m0,
                          mfloat_t f);
...
mfloat_t *mat2_lerp(mfloat_t *result, mfloat_t *m0, mfloat_t *m1,
                    mfloat_t f);
mfloat_t *mat3(mfloat_t *result, mfloat_t m11, mfloat_t m12,
...
mfloat_t *mat3_multiply(mfloat_t *result, mfloat_t *m0,
                        mfloat_t *m1);
mfloat_t *mat3_multiply_f(mfloat_t *result, mfloat_t *m0,
                          mfloat_t f);
...
mfloat_t *mat4_rotation_axis(mfloat_t *result, mfloat_t *v0,
                             mfloat_t f);
...
mfloat_t *mat4_scaling(mfloat_t *result, mfloat_t *m0,
                       mfloat_t *v0);
...
mfloat_t *mat4_ortho(mfloat_t *result, mfloat_t l, mfloat_t r,
...
mfloat_t *mat4_perspective_fov(mfloat_t *result, mfloat_t fov,
...
struct vec2 svec2_clamp(struct vec2 v0, struct vec2 v1,
                        struct vec2 v2);
...
struct vec2 svec2_bezier3(struct vec2 v0, struct vec2 v1,
                          struct vec2 v2, mfloat_t f);
struct vec2 svec2_bezier4(struct vec2 v0, struct vec2 v1,
                          struct vec2 v2, struct vec2 v3, mfloat_t f);
...
struct vec3 svec3_clamp(struct vec3 v0, struct vec3 v1,
                        struct vec3 v2);
...
struct vec3 svec3_bezier3(struct vec3 v0, struct vec3 v1,
                          struct vec3 v2, mfloat_t f);
struct vec3 svec3_bezier4(struct vec3 v0, struct vec3 v1,
                          struct vec3 v2, struct vec3 v3, mfloat_t f);
...
struct vec4 svec4_clamp(struct vec4 v0, struct vec4 v1,
                        struct vec4 v2);
...
struct mat2 smat2(mfloat_t m11, mfloat_t m12, mfloat_t m21,
                  mfloat_t m22);
...
struct mat3 smat3(mfloat_t m11, mfloat_t m12, mfloat_t m13,
...
struct mat4 smat4(mfloat_t m11, mfloat_t m12, mfloat_t m13,
                  mfloat_t m14, mfloat_t m21, mfloat_t m22,
                  mfloat_t m23, mfloat_t m24, mfloat_t m31,
                  mfloat_t m32, mfloat_t m33, mfloat_t m34,
                  mfloat_t m41, mfloat_t m42, mfloat_t m43,
                  mfloat_t m44);
...
struct mat4 smat4_perspective(mfloat_t fov_y, mfloat_t aspect,
                              mfloat_t n, mfloat_t f);
...
#if defined(MATHC_USE_FLOATING_POINT)
struct vec2i *psvec2i_assign_vec2(struct vec2i *result,
                                  struct vec2 *v0);
#endif
...
struct vec2i *psvec2i_subtract(struct vec2i *result, struct vec2i *v0,
                               struct vec2i *v1);
struct vec2i *psvec2i_subtract_i(struct vec2i *result,
                                 struct vec2i *v0, mint_t i);
struct vec2i *psvec2i_multiply(struct vec2i *result, struct vec2i *v0,
                               struct vec2i *v1);
struct vec2i *psvec2i_multiply_i(struct vec2i *result,
                                 struct vec2i *v0, mint_t i);
...
struct vec3i *psvec3i(struct vec3i *result, mint_t x, mint_t y,
                      mint_t z);
struct vec3i *psvec3i_assign(struct vec3i *result, struct vec3i *v0);
#if defined(MATHC_USE_FLOATING_POINT)
struct vec3i *psvec3i_assign_vec3(struct vec3i *result,
                                  struct vec3 *v0);
#endif
...
struct vec3i *psvec3i_subtract(struct vec3i *result, struct vec3i *v0,
                               struct vec3i *v1);
struct vec3i *psvec3i_subtract_i(struct vec3i *result,
                                 struct vec3i *v0, mint_t i);
struct vec3i *psvec3i_multiply(struct vec3i *result, struct vec3i *v0,
                               struct vec3i *v1);
struct vec3i *psvec3i_multiply_i(struct vec3i *result,
                                 struct vec3i *v0, mint_t i);
...
struct vec4i *psvec4i(struct vec4i *result, mint_t x, mint_t y,
                      mint_t z, mint_t w);
struct vec4i *psvec4i_assign(struct vec4i *result, struct vec4i *v0);
#if defined(MATHC_USE_FLOATING_POINT)
struct vec4i *psvec4i_assign_vec4(struct vec4i *result,
                                  struct vec4 *v0);
#endif
...
struct vec4i *psvec4i_subtract(struct vec4i *result, struct vec4i *v0,
                               struct vec4i *v1);
struct vec4i *psvec4i_subtract_i(struct vec4i *result,
                                 struct vec4i *v0, mint_t i);
struct vec4i *psvec4i_multiply(struct vec4i *result, struct vec4i *v0,
                               struct vec4i *v1);
struct vec4i *psvec4i_multiply_i(struct vec4i *result,
                                 struct vec4i *v0, mint_t i);
...
#if defined(MATHC_USE_INT)
struct vec2 *psvec2_assign_vec2i(struct vec2 *result,
                                 struct vec2i *v0);
#endif
...
struct vec2 *psvec2_add(struct vec2 *result, struct vec2 *v0,
                        struct vec2 *v1);
struct vec2 *psvec2_add_f(struct vec2 *result, struct vec2 *v0,
                          mfloat_t f);
...
#if defined(MATHC_USE_INT)
struct vec3 *psvec3_assign_vec3i(struct vec3 *result,
                                 struct vec3i *v0);
#endif
...
struct vec3 *psvec3_add(struct vec3 *result, struct vec3 *v0,
                        struct vec3 *v1);
struct vec3 *psvec3_add_f(struct vec3 *result, struct vec3 *v0,
                          mfloat_t f);
...
#if defined(MATHC_USE_INT)
struct vec4 *psvec4_assign_vec4i(struct vec4 *result,
                                 struct vec4i *v0);
#endif
...
struct vec4 *psvec4_add(struct vec4 *result, struct vec4 *v0,
                        struct vec4 *v1);
struct vec4 *psvec4_add_f(struct vec4 *result, struct vec4 *v0,
                          mfloat_t f);
...
struct quat *psquat_power(struct quat *result, struct quat *q0,
                          mfloat_t exponent);
struct quat *psquat_from_axis_angle(struct quat *result,
                                    struct vec3 *v0, mfloat_t angle);
...
struct mat3 *psmat3(struct mat3 *result, mfloat_t m11, mfloat_t m12,
                    mfloat_t m13, mfloat_t m21, mfloat_t m22,
                    mfloat_t m23, mfloat_t m31, mfloat_t m32,
                    mfloat_t m33);
...
struct mat3 *psmat3_rotation_axis(struct mat3 *result, struct vec3 *v0,
                                  mfloat_t f);
struct mat3 *psmat3_rotation_quat(struct mat3 *result,
                                  struct quat *q0);
...
struct mat4 *psmat4(struct mat4 *result, mfloat_t m11, mfloat_t m12,
                    mfloat_t m13, mfloat_t m14, mfloat_t m21,
                    mfloat_t m22, mfloat_t m23, mfloat_t m24,
                    mfloat_t m31, mfloat_t m32, mfloat_t m33,
                    mfloat_t m34, mfloat_t m41, mfloat_t m42,
                    mfloat_t m43, mfloat_t m44);
...
struct mat4 *psmat4_rotation_axis(struct mat4 *result, struct vec3 *v0,
                                  mfloat_t f);
struct mat4 *psmat4_rotation_quat(struct mat4 *result,
                                  struct quat *q0);
...
struct mat4 *psmat4_ortho(struct mat4 *result, mfloat_t l, mfloat_t r,
                          mfloat_t b, mfloat_t t, mfloat_t n,
                          mfloat_t f);
